...
func main() {
	...
	//delete index ke-0 or first element
	//[1:10] => [low:high] or [strat:end]
	// [low:high] high selalu lebih besar dari low
	//[1:10]=> mulai dari index ke-0 s/d index-10, tapi 10 ga include
	...
	//delete di middle element atau tengah
	numbers = numbers[2:6]
	showBackingArray("numbers", &numbers)

	//delete di middle ut with capacity
	numbers = numbers[:3]
	showBackingArray("numbers", &numbers)
